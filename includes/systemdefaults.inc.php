...
$strftime_format['ymd']         = "%d %B %Y";  // Used in Day view
...
$strftime_format['datetime12']   = "%A %d %B %Y %I:%M:%S%p - %A %d %B %Y";  // 12 hour clock

// $strftime_format['datetime24']   = "%H:%M:%S - %A %d %B %Y";    // 24 hour clock
$strftime_format['datetime24']   = "%A %d %B %Y %H:%M";    // 24 hour clock
