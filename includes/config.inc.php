...
$strftime_format['date']         = "%Y年%b%e日 (%A)";  // Used in Day view
...
$strftime_format['datetime12']   = "%I:%M:%S%p - %Y/%m/%d %A";  // 12 hour clock
// $strftime_format['datetime24']   = "%H:%M:%S - %Y/%m/%d %A";    // 24 hour clock
...
$strftime_format['daymonth']     = "%b%e日";        // Used in trailer
$strftime_format['monyear']      = "%Y年%b";        // Used in trailer

$strftime_format['monthyear']    = "%Y年%b";        // Used in Month view
